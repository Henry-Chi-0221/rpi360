"""v1 transition Player for MP4 playback and optional local diagnostics."""
...
class Player:
    """Legacy playback/live API, retained through v2 for existing Python callers.
    ...
    def mp4(
        ...
        *,
        ...
        warnings.warn(
            "Player.mp4 is a v1 transition API; new applications should use the "
            "v2 media adapters and shared core. Removal is no earlier than v3.",
            DeprecationWarning,
            stacklevel=2,
        )
        return cls(
